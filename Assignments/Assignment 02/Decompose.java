...
public class Decompose {
    public static void main(String[] args) {
        ...
        printBakingInstructions();
        printFrostingInstructions();
    }
    ...
    public static void printPreparationSteps() {
    ...
    public static void printBakingInstructions() {
    ...
    public static void printFrostingInstructions() {
